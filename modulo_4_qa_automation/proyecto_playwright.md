...
| ----------------------------------------------------------------------------------- | -------- | ------------- | --------------------- | ---------- |
| **1.Crear un proyecto de Playwright con Python en GitHub y actualizar README**        | 5%       | 4%            | 2%                    | 0%         |
| **2.Automatizar pruebas de regresión básicas de navegación y páginas informativas**   | 15%      | 10%           | 5%                    | 0%         |
| **3.Automatizar pruebas del formulario de contacto (escenarios válidos e inválidos)** | 25%      | 20%           | 15%                   | 0%         |
| **4.Automatizar pruebas de filtros (escenarios válidos y no válidos)**                | 20%      | 15%           | 10%                   | 0%         |
| **5.Configurar y ejecutar pruebas en GitHub Actions**                                 | 5%       | 4%            | 2%                    | 0%         |
| **6.Reorganizar el proyecto utilizando el patrón Page Object Model**                  | 20%      | 15%           | 10%                   | 0%         |
| **7.Adaptar las pruebas automatizadas para su ejecución en versión móvil**            | 10%      | 8%            | 5%                    | 0%         |
