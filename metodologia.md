...
## Clases en Directo Semanales - 3 Horas

Cada semana habrá **una clase en directo** con la siguiente estructura:

1. **Resolución de dudas**
   - Se resolverán dudas del temario y del proyecto realizado en la semana anterior.

2. **Introducción al trabajo de la semana siguiente**
   - Se explicará el trabajo a realizar durante la semana siguiente.
   - Si es necesario configurar alguna herramienta o entorno, se hará durante la clase para que tengas todo listo para comenzar.
...
3. **Trabajo práctico en clase según tipo de módulo**
   - **Módulos 1 y 4 (Trabajo en equipo)**
     ...
     - Se pondrá en común el trabajo hecho por cada miembro la semana anterior.
     - Se repartiran tareas a cada miembro del equipo para hacer durante la semana.
